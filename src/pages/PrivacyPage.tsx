      ...
      <div className="relative max-w-260 mx-auto">
        ...
        <div className="bg-white p-10 mt-4 md:px-16 md:pb-16 rounded-md shadow-lg">
          ...
          <div className="prose mt-6 md:mt-10">
            ...
            <p>
              BlockPlanner Pty Ltd (ABN 78 688 846 915) (“BlockPlanner”, “we”,
              “our”, “us”) owns and operates the BlockPlanner tool, which is a
              registered trademark of BlockPlanner. BlockPlanner is a digital
              product that helps buyers explore land lots and request builder
              quotes through estate developer websites.
            </p>
            <p>
            ...
            <p>
              ...
              It includes any information or opinion about an identified
            ...
            <ul className="list-disc pl-5 my-2 space-y-1">
              ...
              <li>
                <strong>Financial details:</strong> indicative budget or price
                range.
              </li>
              <li>
              ...
              <li>
                ...
                details, browser type, site interactions, cookies, analytics
                data.
              </li>
              <li>
                <strong>Consent records:</strong> your opt-in or opt-out choices
                for marketing and communications.
              </li>
              <li>
                <strong>Children’s information:</strong> we do not knowingly
                collect personal information from children. If you are under 18,
                parental or guardian consent is required before submitting a
                request.
              </li>
            </ul>
            <p>
              We only collect information that is reasonably necessary for our
              functions, and we take steps to ensure it is accurate, complete,
              and up to date.
            </p>
            ...
            <ul className="list-disc pl-5 my-2 space-y-1">
              ...
              <li>
                Communicate with us, estate developers, or builders through the
                tool.
              </li>
              <li>
            ...
            <p>
              You can choose not to provide information, but if you do, we may
              be unable to generate a quote or respond effectively to your
              enquiry.
            </p>
            ...
            <ul className="list-disc pl-5 my-2 space-y-1">
              <li>
                Generate and deliver builder quotes based on your preferences.
              </li>
              <li>
                Share your details with estate developers and their authorised
                sales teams so they can respond to your enquiry.
              </li>
              <li>
                Share your details with selected builders so they can prepare
                and deliver quotes.
              </li>
              <li>
              ...
              <li>
                Send marketing communications if you have opted in (with clear
                opt-out at any time).
              </li>
              <li>Meet our legal and regulatory obligations.</li>
              <li>
                Manage risks, conduct audits, and run privacy impact assessments
                where required.
              </li>
            </ul>
            <p>
              ...
              BlockPlanner to participate in the quoting process. These builders
              are independent organisations. They receive your details only for
              the purpose of preparing and delivering a quote and are expected
              to handle your personal information in accordance with Australian
              privacy law.
            </p>
            ...
            <ul className="list-disc pl-5 my-2 space-y-1">
              <li>
                Filtering plans and lots according to your stated preferences.
              </li>
            ...
            <p>
              ...
              estate developers always review and issue the final quote. If an
              automated process materially influences the quote you receive, you
            ...
            <ul className="list-disc pl-5 my-2 space-y-1">
              ...
              <li>
                Professional advisers, insurers, or regulators where required by
                law.
              </li>
            </ul>
            <p>
            ...
            <p>
              ...
              Australia. These may include the United States, Singapore, and the
              European Union. We take reasonable steps to ensure that overseas
              recipients comply with obligations substantially similar to
            ...
            <ul className="list-disc pl-5 my-2 space-y-1">
              ...
              <li>
                Correction of information that is inaccurate, incomplete, or out
                of date.
              </li>
            </ul>
            <p>
              Requests should be made to the Privacy Officer. We will respond
              within 30 days and there is no charge for making a request.
            </p>

            <h3>9. Complaints</h3>
            <p>
              If you believe we have breached the APPs or this Privacy Policy,
              you may lodge a complaint with our Privacy Officer (see contact
              above). We will acknowledge receipt within 7 days and provide a
              written response within 30 days.
            </p>
            <p>
              If you are not satisfied with our handling of your complaint, you
            ...
            <p>
              If your information is involved in a data breach that is likely to
              cause serious harm, we will notify you and the OAIC in line with
            ...
            <p>
              ...
              will be posted on this page with a revised effective date. For
              material changes, we will provide additional notice (e.g. on the
              website or by email, if appropriate).
            </p>
            <p className="mt-10">
