        ...
        <div className="bg-white p-10 md:px-16 md:pb-16 rounded-md shadow-lg">
          ...
          {status === "success" && (
            <div className="mt-15 mb-10 space-y-4">
              ...
              <Heading tag="p" size="h4">
                Thank you for your purchase. We have received your order and our
                team is getting started on your custom assessment.
              </Heading>
          ...
          {status === "cancel" && (
            <div className="mt-15 mb-10 space-y-4">
              ...
              <p className="text-lg text-gray-600">
                If you changed your mind or encountered an issue, you can return
                to your free assessment below and try again when you are ready.
              </p>
            </div>
          )}
