  ...
  return (
    <div ref={searchRef} className="relative flex items-center gap-2">
      {isSearchVisible && (
        <div className="relative">
          ...
          <input
            ...
            className={`w-64 pl-10 pr-10 py-2 border border-gray-300 bg-white rounded-lg focus:outline-none focus:ring-2 focus:${getColorClass(
              "primary",
              "ring"
      ...
      <button
        ...
        className={`p-2 border bg-white border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:${getColorClass(
          "primary",
          "ring"
        )} focus:border-transparent`}
        ...
        <div className="absolute top-full right-0 mt-1 bg-white border border-gray-300 rounded-lg shadow-lg z-50 max-h-60 overflow-y-auto w-64">
          ...
          {isLoading ? (
            <div className="p-3 text-center text-gray-500">
              <div
                className={`animate-spin rounded-full h-4 w-4 border-b-2 ${getColorClass(
                  "primary",
                  "border"
                )} mx-auto`}
              ></div>
